class NoveltiesController < ApplicationController
  ...
  private
    ...
    def novelty_params
      params.require(:novelty).permit(:year, :month, :service_of_dependence_id, novelty_details_attributes: [:id, :url, :_destroy, :agent_id, :novelty_type_id, :hours_type, :year_ref, :month_ref, :hours_to_add, :hours_to_remove, :associated_concept])
    end
end
