class ReportsController < ApplicationController
  ...
  def new
    ...
    #if !@report_details.observations.any?
      #@report_details.observations.build
    #end
    #if !@report_details.observations.any?
      #@report_details.observations.build
    #end
